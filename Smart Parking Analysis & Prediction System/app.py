...
This system utilizes a custom-trained model, trained to detect vehicles and determine parking spot status in real-time.
...
if uploaded_file is not None:
    ...
    with st.spinner('Analyzing the image... please wait...'):
        ...
        with col_metrics:
            ...
            st.info(f"Found {empty_spaces} empty and {occupied_spaces} occupied spots.")
